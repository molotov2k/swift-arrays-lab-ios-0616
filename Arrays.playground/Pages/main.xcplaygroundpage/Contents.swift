...
futureShoppingList = ["Bread", "Butter", "Cheese", "Lettuce", "Tomato"]
...
let cheeseSandwich: [String] = ["Bread", "Butter", "Cheese", "Lettuce", "Tomato"]
...
var result = lifesEssential(shoppingList)
...
result = lifesEssential(desertList)
